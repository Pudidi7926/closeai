...
export default function App() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (!response) throw new Error("Gagal mendapatkan respon dari AI.");
      ...
      if (error.message?.includes('503') || error.message?.includes('high demand')) {
        friendlyError = "Layanan sedang sibuk (Traffic tinggi). AI akan otomatis mencoba kembali atau silakan kirim ulang pesan Anda dalam beberapa saat.";
      }
