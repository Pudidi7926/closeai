          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Groq Llama 3.3 Active</span>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-4">
        ...
        <div className="p-6 md:p-10">
          <div className="max-w-4xl mx-auto relative">
            ...
            <p className="text-[10px] text-center mt-4 text-gray-400 font-bold uppercase tracking-widest leading-loose">
              Didukung oleh Llama 3.3 GroqCloud & Close AI Core. Semua data terenkripsi lokal.
            </p>
          </div>
        </div>
      </main>
